...
class UniversalTimezone extends Equatable implements Timezone {
  ...
  int offset(int millisecondsSinceEpoch) =>
      _getSpan(millisecondsSinceEpoch).offset;
  ...
  int convert(
    ...
    } else if (localOffset >= 0 && !adjustedSpan.isFirst) {
      final previousSpan = _getSpan(adjustedSpan.startTime - 1);
...
class _Span {
  ...
  @override
  String toString() {
    return 'Span($startTime, $endTime, $offset)';
  }
}
